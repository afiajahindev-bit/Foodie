...
<body>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          ...
          <div>
            ...
            ?>
            <form action="food.php" method="post" class="d-flex" role="search">
  ...
  <section id="features" data-bs-spy="scroll" data-bs-target="#simple-list-example" data-bs-offset="100" data-bs-smooth-scroll="true" class="scrollspy-example" tabindex="0">
    <!-- Part1 -->
