...
<body>
    ...
    <form action="map.php" method="POST">
        <input placeholder="latitude" type="text" name="latitude" id="latitude" value="" required />
        <input placeholder="longitude" type="text" name="longitude" id="longitude" value="" required />
        <input placeholder="locationName" type="text" name="locationName" id="locationName" value="" required />
    ...
    ?>
        ...
        <input type="hidden" id="loc" value="<?= $locationName; ?>">
    <?php
    }
    ?>
    <div id="map"></div>
